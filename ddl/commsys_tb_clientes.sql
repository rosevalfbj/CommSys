...
CREATE TABLE `tb_clientes` (
  ...
  `Endereco_cli` varchar(80) DEFAULT NULL,
  `Bairro_cli` varchar(40) DEFAULT NULL,
  `Cnpj_cli` varchar(20) DEFAULT NULL,
  `Telefone_cli` varchar(20) DEFAULT NULL,
  `Email_cli` varchar(40) DEFAULT NULL,
  `Codigo_cid` int(11) DEFAULT NULL,
  PRIMARY KEY (`Codigo_cli`),
  KEY `R_7` (`Codigo_cid`),
  CONSTRAINT `tb_clientes_ibfk_1` FOREIGN KEY (`Codigo_cid`) REFERENCES `tb_cidades` (`Codigo_cid`)
...
-- Dump completed on 2016-10-02 17:38:49
